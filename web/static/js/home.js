...
function showInsert() {
    ...
    $("#btnOK").on("click", function () {
        ...
        var email = $("#email").val();
        var json = "{ \"id\":" + 0 + ",\"name\":\"" + name + "\",\"address\":\"" + address
            + "\",\"phone\":\"" + phone
            + "\",\"mobile\":\"" + mobile
            + "\",\"email\":\"" + email
            + "\"}";
...
function search() {
    var updateUrl = "http://localhost:8080/api/contactservice/contactName?name=";
